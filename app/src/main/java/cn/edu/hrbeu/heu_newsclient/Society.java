...
public class Society extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mNews = (ListView)findViewById(R.id.newsList_society);
        ...
        mNews.setOnItemClickListener(new OnItemClickListener(){
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				in.setClass(Society.this, NewsDetail.class);
				startActivity(in);
			}
	...
	void httpGet() {
    	...
    	task.execute(ServerWebRoot.getServerWebRoot()+"Society.xml");
    }
